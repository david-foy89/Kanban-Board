...
export function ShareBoardButton() {
  ...
  return (
    <button
      ...
      title="Create a link others can use to edit this board in real time"
    >
      ...
      {statusLabel && collab.roomId && (
        <span className="hidden rounded-full bg-emerald-500/20 px-1.5 py-0.5 text-[10px] text-emerald-400 lg:inline">
          {statusLabel}
        </span>
      )}
    </button>
